...
#ifndef HISTORY_VERSION
#define HISTORY_VERSION  (1)                 // fixed 0 before 1st formal release
//#warning "default to 0"
//change HISTORY_VERSION to 1 for changing time precision of history to millisecond
#endif
